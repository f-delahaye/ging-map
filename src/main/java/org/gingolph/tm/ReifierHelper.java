...
public class ReifierHelper {
    ...
    public static void setReifier(Reifiable reified, Topic reifier, Consumer<TopicImpl> setter) throws ModelConstraintException {
        if (reifier == null) {
            ...
            if (reifier.getReified() != null && (!reifier.getReified().equals(reified))) {
                throw new ModelConstraintException(reified, reifier+" already reifies "+reifier.getReified());
            }
