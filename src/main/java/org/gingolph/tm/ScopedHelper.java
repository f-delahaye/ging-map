...
public class ScopedHelper {
    ...
    public static <T extends TopicMapItem & Scoped> void setScope(T scoped, Collection<Topic> scope, ScopedSupport support) {
        if (scope != null) {
    ...
    public static <T extends TopicMapItem & Scoped> void addTheme(T scoped, Topic theme, ScopedSupport support) throws ModelConstraintException {
        if (theme == null) {
    ...
    public static <T extends TopicMapItem & Scoped> void removeTheme(T scoped, Topic theme, ScopedSupport support) {
