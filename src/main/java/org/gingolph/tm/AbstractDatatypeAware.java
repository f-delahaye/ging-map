...
public abstract class AbstractDatatypeAware<P extends Construct, S extends DatatypeAwareSupport> extends TopicMapItem<P, S> implements DatatypeAware, Valued {
