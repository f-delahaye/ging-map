...
public class RoleImpl extends TopicMapItem<AssociationImpl, RoleSupport> implements Role, TypedConstruct {
...
//    }
    ...
    // According to the TopicMap specs, roles are deemed equals if they have the same player, type and parent.
    // But I can't see how TestTopic.testRoleAssociationFilter can work with that (role1 and role2 have the same player, type and parent so getRolesPlayed(), which returns a set, should haved 1 item, not 2)
